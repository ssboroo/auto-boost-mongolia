...
export default function PrivacyPage() {
  return <main className={styles.page}><div className={styles.shell}>
    <div className={styles.top}><Link className={styles.brand} href="/"><span className={styles.brandMark}><ShieldCheck size={19}/></span>RAINY</Link><Link className={styles.back} href="/">← Нүүр хуудас</Link></div>
    <article className={styles.card}>
      <span className={styles.eyebrow}>НУУЦЛАЛ</span><h1>Нууцлалын бодлого</h1><div className={styles.updated}>Сүүлд шинэчилсэн: 2026-09-03</div>
      <section className={styles.section}><h2>1. Бид ямар мэдээлэл боловсруулдаг вэ?</h2><p>RAINY нь хэрэглэгчийн бүртгэлийн имэйл, workspace-ийн мэдээлэл, Meta/Facebook холболтын таних мэдээлэл, зарын draft ба тохиргоо, төлбөрийн гүйлгээний төлөв, аудит болон аюулгүй ажиллагааны лог зэрэг үйлчилгээг ажиллуулахад шаардлагатай мэдээллийг боловсруулна.</p></section>
      <section className={styles.section}><h2>2. Meta/Facebook мэдээлэл</h2><p>Facebook-ээ холбоход Meta OAuth-оор зөвшөөрсөн permission-ийн хүрээнд Page, Ad Account болон зар удирдахад шаардлагатай мэдээлэл авна. Access token нь browser-д ил гарахгүй, backend талд шифрлэгдэн хадгалагдана. RAINY нь хэрэглэгчийн баталгаагүйгээр зарын spend-ийг автоматаар ACTIVE болгохгүй.</p></section>
      ...
      <div className={styles.notice}>Энэ бодлого нь RAINY платформын одоогийн техникийн ажиллагааг тайлбарлана. Бизнесийн албан ёсны хаяг, оператор компанийн нэр, privacy contact мэдээллийг public launch-аас өмнө компанийн бодит мэдээллээр нөхнө.</div>
