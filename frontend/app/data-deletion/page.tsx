...
export default function DataDeletionPage() {
  return <main className={styles.page}><div className={styles.shell}>
    <div className={styles.top}><Link className={styles.brand} href="/"><span className={styles.brandMark}><Trash2 size={19}/></span>AUTO BOOST MONGOLIA</Link><Link className={styles.back} href="/">← Нүүр хуудас</Link></div>
    <article className={styles.card}>
      <span className={styles.eyebrow}>Data Deletion</span><h1>Мэдээлэл устгуулах заавар</h1><div className={styles.updated}>Сүүлд шинэчилсэн: 2026-09-03</div>
      <section className={styles.section}><h2>Facebook/Meta холболтоо салгах</h2><p>Auto Boost Mongolia-д нэвтэрч Facebook холболтын хэсгээс disconnect хийснээр тухайн workspace-ийн хадгалсан Meta access token устгагдана. Мөн Facebook Settings → Apps and Websites хэсгээс Auto Boost Mongolia-ийн access-ийг revoke хийж болно.</p></section>
